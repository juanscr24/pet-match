...
import { AdoptionVideo } from "../AdoptionVideo";
import { FeaturedPetsSlider } from "../FeaturedPetsSlider";
...
export const AboutUsSection = () => {
    ...
    return (
        <div className="min-h-screen text-white p-5 max-sm:p-0 max-lg:px-3 flex justify-center items-center">
            <div className="bg-black/40 backdrop-blur-xl max-sm:backdrop-blur-none rounded-2xl shadow-lg p-8 w-[80%] max-lg:w-[100%] max-sm:bg-black/0 max space-y-10">
