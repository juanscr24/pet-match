...
export const ChatModal = ({ onClose, pet, currentUser }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="bg-white rounded-xl w-[90%] max-w-md p-5 shadow-xl relative">
                ...
                <div className="h-64 overflow-y-auto border rounded-lg p-3 mb-4 bg-gray-100 space-y-2">
                    {messages.map((msg, idx) => (
                        <div
                            key={idx}
                            className={`p-2 rounded-lg max-w-[80%] ${msg.senderId === currentUser.id ? 'bg-blue-500 text-white ml-auto' : 'bg-gray-300 text-black'}`}
                        >
                            {msg.message}
